...
public class MainActivity extends Activity {
    ...
    void sholatHajatCounter(LinearLayout box){
        ...
        LinearLayout.LayoutParams cp=new LinearLayout.LayoutParams(-1,dp(82));
        cp.setMargins(0,dp(14),0,dp(28));
        box.addView(counter,cp);

        Button hitung=btn("HITUNG");
        hitung.setTextSize(16);
        LinearLayout.LayoutParams hp=new LinearLayout.LayoutParams(-1,dp(92));
        hp.setMargins(dp(20),dp(10),dp(20),dp(54));
    ...
    void dzikir(LinearLayout box,String title,String arab,String latin,int target){
        ...
        tap.setTextSize(16);
        LinearLayout.LayoutParams tp=new LinearLayout.LayoutParams(-1,dp(92));
        tp.setMargins(dp(20),dp(10),dp(20),dp(54));
        box.addView(tap,tp);
    ...
    void addNav(int p){
        ...
        if(child instanceof ScrollFrame){
            ...
            sfp.rightMargin=0;
            sfp.topMargin=0;
            sfp.bottomMargin=navHeight+navBottom+dp(32);
            sf.setLayoutParams(sfp);
            sf.setPadding(0,0,0,dp(28));
